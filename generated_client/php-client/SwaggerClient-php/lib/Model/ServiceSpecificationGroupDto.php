...
class ServiceSpecificationGroupDto extends IElementDto 
{
     ...
     *
     * @param \Swagger\Client\Model\ComissionStatusDto $comission_status Indicates if this service specification group is commissioned (and therefore should be executed), postponed for later or undefined.
     *
     * @return $this
     */
     ...
     * Sets item_number
     *
     * @param \Swagger\Client\Model\ItemNumberDto $item_number The ItemNumber for this INumberedElement interface.
     *
     * @return $this
     */
