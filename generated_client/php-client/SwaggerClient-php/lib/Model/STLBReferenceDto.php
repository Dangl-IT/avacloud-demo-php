...
class STLBReferenceDto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cost_group' => 'string',
        'service_area' => 'string',
        'keys' => '\Swagger\Client\Model\STLBKeyDto[]'
    ];
     ...
     * Gets keys
     *
     * @return \Swagger\Client\Model\STLBKeyDto[]
     */
     ...
     * Sets keys
     *
     * @param \Swagger\Client\Model\STLBKeyDto[] $keys These keys may optionally be used to further reference multiple, specific items within the STLB
     *
     * @return $this
     */
