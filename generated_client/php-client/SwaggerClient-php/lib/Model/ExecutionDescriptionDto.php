...
class ExecutionDescriptionDto extends IElementDto 
{
    ...
    protected static $swaggerTypes = [
        'blocks' => '\Swagger\Client\Model\NoteTextDto[]',
        'label' => 'string',
        'identifier' => 'string',
        'element_type' => 'string'
    ];
     ...
     * Gets blocks
     *
     * @return \Swagger\Client\Model\NoteTextDto[]
     */
     ...
     * Sets blocks
     *
     * @param \Swagger\Client\Model\NoteTextDto[] $blocks Blocks within an ExecutionDescription contain the actual information.
     *
     * @return $this
     */
